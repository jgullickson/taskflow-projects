/**
 * These are options for the configuration file. 
 * These get parsed by the editor for online configuration.
 */
...
/**
 * Direction for target and flankers.
 */
const DIRECTION = {
    RIGHT: "RIGHT",
    LEFT: "LEFT"
 ...
 */
const ADVANCE = {
    BACKWARDS: "ADVANCE.BACKWARDS",
    FORWARD: "ADVANCE.FORWARD",
    NEUTRAL: "ADVANCE.NEUTRAL"
};